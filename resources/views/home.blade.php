...
@section('content')
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="w-full lg:w-3/5 space-y-8 text-center lg:text-left">
                    ...
                    <h1 class="text-5xl lg:text-7xl font-extrabold text-slate-900 tracking-tight leading-tight">
                        {{-- Menampilkan Headline. Jika ada kata pertama dan kedua, kita beri warna beda --}}
                        @php
                            $headline = $profile->headline ?? 'Web Developer';
                            $words = explode(' ', $headline);
                            $firstWord = array_shift($words); // Ambil kata pertama
                            $restWords = implode(' ', $words); // Sisa kata
                        @endphp
                ...
                <div class="w-full lg:w-2/5 flex justify-center">
                    <div class="relative w-80 h-80 md:w-96 md:h-96">
                        ...
                        <div class="absolute inset-0 bg-white rounded-[2rem] shadow-2xl overflow-hidden border-4 border-white rotate-0 hover:-rotate-2 transition duration-500">
                            ...
                            @else
                                <!-- Placeholder jika user belum upload foto -->
    ...
    <!-- Skills Section -->
    <section id="skills" class="py-24 bg-slate-900 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-12">
                ...
                <div>
                    ...
                    <div class="relative border-l-2 border-slate-200 ml-3 space-y-10">
                        ...
                        <div class="relative pl-8">
                            <span class="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-white border-4 border-indigo-400"></span>
                            <span class="text-xs font-bold text-indigo-600 uppercase tracking-wider bg-indigo-50 px-2 py-1 rounded mb-2 inline-block">{{ $edu->period }}</span>
                            <h4 class="text-lg font-bold text-slate-900">{{ $edu->role }}</h4> <!-- Role dipakai sbg Jurusan/Gelar -->
                            <div class="text-slate-500 font-medium text-sm mb-2">{{ $edu->company }}</div> <!-- Company dipakai sbg Kampus -->
    ...
    <section id="contact" class="py-24 bg-indigo-600 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 relative z-10">
            ...
            <!-- ALERT SUKSES (Muncul jika pesan terkirim) -->
            @if(session('success'))
            ...
            <div class="mt-12 flex flex-col md:flex-row justify-center gap-8 text-center md:text-left text-indigo-100">
                ...
                <div class="flex items-center justify-center gap-3">
                    ...
                    <span>linkedin.com/in/rian</span>
                </div>
            </div>
